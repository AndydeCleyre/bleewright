...
(wheezy.template templates/kde.colors.wz tmp/vars/DimWitWell.json >schemes/kde/DimWitWell.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/HotBrown.json >schemes/kde/HotBrown.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/KanagawaMacaroni.json >schemes/kde/KanagawaMacaroni.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/Lavenoni.json >schemes/kde/Lavenoni.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/MacaroniTime.json >schemes/kde/MacaroniTime.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/OneDarkMacaroni.json >schemes/kde/OneDarkMacaroni.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/PurpleMacaroni.json >schemes/kde/PurpleMacaroni.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/UglyMacaroni.json >schemes/kde/UglyMacaroni.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/Violi.json >schemes/kde/Violi.colors)
...
(ouch c --yes -f zip tmp/firefox/DimWitWell/manifest.json schemes/firefox/DimWitWell.xpi)
(ouch c --yes -f zip tmp/firefox/HotBrown/manifest.json schemes/firefox/HotBrown.xpi)
(ouch c --yes -f zip tmp/firefox/KanagawaMacaroni/manifest.json schemes/firefox/KanagawaMacaroni.xpi)
(ouch c --yes -f zip tmp/firefox/Lavenoni/manifest.json schemes/firefox/Lavenoni.xpi)
(ouch c --yes -f zip tmp/firefox/MacaroniTime/manifest.json schemes/firefox/MacaroniTime.xpi)
(ouch c --yes -f zip tmp/firefox/OneDarkMacaroni/manifest.json schemes/firefox/OneDarkMacaroni.xpi)
(ouch c --yes -f zip tmp/firefox/PurpleMacaroni/manifest.json schemes/firefox/PurpleMacaroni.xpi)
(ouch c --yes -f zip tmp/firefox/UglyMacaroni/manifest.json schemes/firefox/UglyMacaroni.xpi)
(ouch c --yes -f zip tmp/firefox/Violi/manifest.json schemes/firefox/Violi.xpi)
(wheezy.template templates/trit.json.wz tmp/vars/DimWitWell.json >tmp/vars/DimWitWellTrit.json)
(wheezy.template templates/trit.json.wz tmp/vars/HotBrown.json >tmp/vars/HotBrownTrit.json)
(wheezy.template templates/trit.json.wz tmp/vars/KanagawaMacaroni.json >tmp/vars/KanagawaMacaroniTrit.json)
(wheezy.template templates/trit.json.wz tmp/vars/Lavenoni.json >tmp/vars/LavenoniTrit.json)
(wheezy.template templates/trit.json.wz tmp/vars/MacaroniTime.json >tmp/vars/MacaroniTimeTrit.json)
(wheezy.template templates/trit.json.wz tmp/vars/OneDarkMacaroni.json >tmp/vars/OneDarkMacaroniTrit.json)
(wheezy.template templates/trit.json.wz tmp/vars/PurpleMacaroni.json >tmp/vars/PurpleMacaroniTrit.json)
(wheezy.template templates/trit.json.wz tmp/vars/UglyMacaroni.json >tmp/vars/UglyMacaroniTrit.json)
(wheezy.template templates/trit.json.wz tmp/vars/Violi.json >tmp/vars/VioliTrit.json)
(wheezy.template templates/kde.colors.wz tmp/vars/DimWitWellTrit.json >schemes/kde/DimWitWellTrit.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/HotBrownTrit.json >schemes/kde/HotBrownTrit.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/KanagawaMacaroniTrit.json >schemes/kde/KanagawaMacaroniTrit.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/LavenoniTrit.json >schemes/kde/LavenoniTrit.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/MacaroniTimeTrit.json >schemes/kde/MacaroniTimeTrit.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/OneDarkMacaroniTrit.json >schemes/kde/OneDarkMacaroniTrit.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/PurpleMacaroniTrit.json >schemes/kde/PurpleMacaroniTrit.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/UglyMacaroniTrit.json >schemes/kde/UglyMacaroniTrit.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/VioliTrit.json >schemes/kde/VioliTrit.colors)
...
(ouch c --yes -f zip tmp/firefox/DimWitWellTrit/manifest.json schemes/firefox/DimWitWellTrit.xpi)
(ouch c --yes -f zip tmp/firefox/HotBrownTrit/manifest.json schemes/firefox/HotBrownTrit.xpi)
(ouch c --yes -f zip tmp/firefox/KanagawaMacaroniTrit/manifest.json schemes/firefox/KanagawaMacaroniTrit.xpi)
(ouch c --yes -f zip tmp/firefox/LavenoniTrit/manifest.json schemes/firefox/LavenoniTrit.xpi)
(ouch c --yes -f zip tmp/firefox/MacaroniTimeTrit/manifest.json schemes/firefox/MacaroniTimeTrit.xpi)
(ouch c --yes -f zip tmp/firefox/OneDarkMacaroniTrit/manifest.json schemes/firefox/OneDarkMacaroniTrit.xpi)
(ouch c --yes -f zip tmp/firefox/PurpleMacaroniTrit/manifest.json schemes/firefox/PurpleMacaroniTrit.xpi)
(ouch c --yes -f zip tmp/firefox/UglyMacaroniTrit/manifest.json schemes/firefox/UglyMacaroniTrit.xpi)
(ouch c --yes -f zip tmp/firefox/VioliTrit/manifest.json schemes/firefox/VioliTrit.xpi)
(wheezy.template templates/prot.json.wz tmp/vars/DimWitWell.json >tmp/vars/DimWitWellProt.json)
(wheezy.template templates/prot.json.wz tmp/vars/HotBrown.json >tmp/vars/HotBrownProt.json)
(wheezy.template templates/prot.json.wz tmp/vars/KanagawaMacaroni.json >tmp/vars/KanagawaMacaroniProt.json)
(wheezy.template templates/prot.json.wz tmp/vars/Lavenoni.json >tmp/vars/LavenoniProt.json)
(wheezy.template templates/prot.json.wz tmp/vars/MacaroniTime.json >tmp/vars/MacaroniTimeProt.json)
(wheezy.template templates/prot.json.wz tmp/vars/OneDarkMacaroni.json >tmp/vars/OneDarkMacaroniProt.json)
(wheezy.template templates/prot.json.wz tmp/vars/PurpleMacaroni.json >tmp/vars/PurpleMacaroniProt.json)
(wheezy.template templates/prot.json.wz tmp/vars/UglyMacaroni.json >tmp/vars/UglyMacaroniProt.json)
(wheezy.template templates/prot.json.wz tmp/vars/Violi.json >tmp/vars/VioliProt.json)
(wheezy.template templates/kde.colors.wz tmp/vars/DimWitWellProt.json >schemes/kde/DimWitWellProt.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/HotBrownProt.json >schemes/kde/HotBrownProt.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/KanagawaMacaroniProt.json >schemes/kde/KanagawaMacaroniProt.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/LavenoniProt.json >schemes/kde/LavenoniProt.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/MacaroniTimeProt.json >schemes/kde/MacaroniTimeProt.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/OneDarkMacaroniProt.json >schemes/kde/OneDarkMacaroniProt.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/PurpleMacaroniProt.json >schemes/kde/PurpleMacaroniProt.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/UglyMacaroniProt.json >schemes/kde/UglyMacaroniProt.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/VioliProt.json >schemes/kde/VioliProt.colors)
...
(ouch c --yes -f zip tmp/firefox/DimWitWellProt/manifest.json schemes/firefox/DimWitWellProt.xpi)
(ouch c --yes -f zip tmp/firefox/HotBrownProt/manifest.json schemes/firefox/HotBrownProt.xpi)
(ouch c --yes -f zip tmp/firefox/KanagawaMacaroniProt/manifest.json schemes/firefox/KanagawaMacaroniProt.xpi)
(ouch c --yes -f zip tmp/firefox/LavenoniProt/manifest.json schemes/firefox/LavenoniProt.xpi)
(ouch c --yes -f zip tmp/firefox/MacaroniTimeProt/manifest.json schemes/firefox/MacaroniTimeProt.xpi)
(ouch c --yes -f zip tmp/firefox/OneDarkMacaroniProt/manifest.json schemes/firefox/OneDarkMacaroniProt.xpi)
(ouch c --yes -f zip tmp/firefox/PurpleMacaroniProt/manifest.json schemes/firefox/PurpleMacaroniProt.xpi)
(ouch c --yes -f zip tmp/firefox/UglyMacaroniProt/manifest.json schemes/firefox/UglyMacaroniProt.xpi)
(ouch c --yes -f zip tmp/firefox/VioliProt/manifest.json schemes/firefox/VioliProt.xpi)
(wheezy.template templates/deuter.json.wz tmp/vars/DimWitWell.json >tmp/vars/DimWitWellDeuter.json)
(wheezy.template templates/deuter.json.wz tmp/vars/HotBrown.json >tmp/vars/HotBrownDeuter.json)
(wheezy.template templates/deuter.json.wz tmp/vars/KanagawaMacaroni.json >tmp/vars/KanagawaMacaroniDeuter.json)
(wheezy.template templates/deuter.json.wz tmp/vars/Lavenoni.json >tmp/vars/LavenoniDeuter.json)
(wheezy.template templates/deuter.json.wz tmp/vars/MacaroniTime.json >tmp/vars/MacaroniTimeDeuter.json)
(wheezy.template templates/deuter.json.wz tmp/vars/OneDarkMacaroni.json >tmp/vars/OneDarkMacaroniDeuter.json)
(wheezy.template templates/deuter.json.wz tmp/vars/PurpleMacaroni.json >tmp/vars/PurpleMacaroniDeuter.json)
(wheezy.template templates/deuter.json.wz tmp/vars/UglyMacaroni.json >tmp/vars/UglyMacaroniDeuter.json)
(wheezy.template templates/deuter.json.wz tmp/vars/Violi.json >tmp/vars/VioliDeuter.json)
(wheezy.template templates/kde.colors.wz tmp/vars/DimWitWellDeuter.json >schemes/kde/DimWitWellDeuter.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/HotBrownDeuter.json >schemes/kde/HotBrownDeuter.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/KanagawaMacaroniDeuter.json >schemes/kde/KanagawaMacaroniDeuter.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/LavenoniDeuter.json >schemes/kde/LavenoniDeuter.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/MacaroniTimeDeuter.json >schemes/kde/MacaroniTimeDeuter.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/OneDarkMacaroniDeuter.json >schemes/kde/OneDarkMacaroniDeuter.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/PurpleMacaroniDeuter.json >schemes/kde/PurpleMacaroniDeuter.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/UglyMacaroniDeuter.json >schemes/kde/UglyMacaroniDeuter.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/VioliDeuter.json >schemes/kde/VioliDeuter.colors)
...
(ouch c --yes -f zip tmp/firefox/DimWitWellDeuter/manifest.json schemes/firefox/DimWitWellDeuter.xpi)
(ouch c --yes -f zip tmp/firefox/HotBrownDeuter/manifest.json schemes/firefox/HotBrownDeuter.xpi)
(ouch c --yes -f zip tmp/firefox/KanagawaMacaroniDeuter/manifest.json schemes/firefox/KanagawaMacaroniDeuter.xpi)
(ouch c --yes -f zip tmp/firefox/LavenoniDeuter/manifest.json schemes/firefox/LavenoniDeuter.xpi)
(ouch c --yes -f zip tmp/firefox/MacaroniTimeDeuter/manifest.json schemes/firefox/MacaroniTimeDeuter.xpi)
(ouch c --yes -f zip tmp/firefox/OneDarkMacaroniDeuter/manifest.json schemes/firefox/OneDarkMacaroniDeuter.xpi)
(ouch c --yes -f zip tmp/firefox/PurpleMacaroniDeuter/manifest.json schemes/firefox/PurpleMacaroniDeuter.xpi)
(ouch c --yes -f zip tmp/firefox/UglyMacaroniDeuter/manifest.json schemes/firefox/UglyMacaroniDeuter.xpi)
(ouch c --yes -f zip tmp/firefox/VioliDeuter/manifest.json schemes/firefox/VioliDeuter.xpi)
(wheezy.template templates/rot30.json.wz tmp/vars/DimWitWell.json >tmp/vars/DimWitWellRot30.json)
(wheezy.template templates/rot30.json.wz tmp/vars/HotBrown.json >tmp/vars/HotBrownRot30.json)
(wheezy.template templates/rot30.json.wz tmp/vars/KanagawaMacaroni.json >tmp/vars/KanagawaMacaroniRot30.json)
(wheezy.template templates/rot30.json.wz tmp/vars/Lavenoni.json >tmp/vars/LavenoniRot30.json)
(wheezy.template templates/rot30.json.wz tmp/vars/MacaroniTime.json >tmp/vars/MacaroniTimeRot30.json)
(wheezy.template templates/rot30.json.wz tmp/vars/OneDarkMacaroni.json >tmp/vars/OneDarkMacaroniRot30.json)
(wheezy.template templates/rot30.json.wz tmp/vars/PurpleMacaroni.json >tmp/vars/PurpleMacaroniRot30.json)
(wheezy.template templates/rot30.json.wz tmp/vars/UglyMacaroni.json >tmp/vars/UglyMacaroniRot30.json)
(wheezy.template templates/rot30.json.wz tmp/vars/Violi.json >tmp/vars/VioliRot30.json)
(wheezy.template templates/kde.colors.wz tmp/vars/DimWitWellRot30.json >schemes/kde/DimWitWellRot30.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/HotBrownRot30.json >schemes/kde/HotBrownRot30.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/KanagawaMacaroniRot30.json >schemes/kde/KanagawaMacaroniRot30.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/LavenoniRot30.json >schemes/kde/LavenoniRot30.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/MacaroniTimeRot30.json >schemes/kde/MacaroniTimeRot30.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/OneDarkMacaroniRot30.json >schemes/kde/OneDarkMacaroniRot30.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/PurpleMacaroniRot30.json >schemes/kde/PurpleMacaroniRot30.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/UglyMacaroniRot30.json >schemes/kde/UglyMacaroniRot30.colors)
(wheezy.template templates/kde.colors.wz tmp/vars/VioliRot30.json >schemes/kde/VioliRot30.colors)
...
(ouch c --yes -f zip tmp/firefox/DimWitWellRot30/manifest.json schemes/firefox/DimWitWellRot30.xpi)
(ouch c --yes -f zip tmp/firefox/HotBrownRot30/manifest.json schemes/firefox/HotBrownRot30.xpi)
(ouch c --yes -f zip tmp/firefox/KanagawaMacaroniRot30/manifest.json schemes/firefox/KanagawaMacaroniRot30.xpi)
(ouch c --yes -f zip tmp/firefox/LavenoniRot30/manifest.json schemes/firefox/LavenoniRot30.xpi)
(ouch c --yes -f zip tmp/firefox/MacaroniTimeRot30/manifest.json schemes/firefox/MacaroniTimeRot30.xpi)
(ouch c --yes -f zip tmp/firefox/OneDarkMacaroniRot30/manifest.json schemes/firefox/OneDarkMacaroniRot30.xpi)
(ouch c --yes -f zip tmp/firefox/PurpleMacaroniRot30/manifest.json schemes/firefox/PurpleMacaroniRot30.xpi)
(ouch c --yes -f zip tmp/firefox/UglyMacaroniRot30/manifest.json schemes/firefox/UglyMacaroniRot30.xpi)
(ouch c --yes -f zip tmp/firefox/VioliRot30/manifest.json schemes/firefox/VioliRot30.xpi)
